...
const Detail = () => {
  ...
  const [courses2, setCourses] = useState(video);
  ...
  return (
    <>
      ...
      {/* Banner */}
      <section className="relative top-[10px] sm:top-[100px] h-[420px] sm:h-[400px] flex items-center text-left text-white px-20 mt-[100px] sm:my-10 mx-10 sm:mx-64 rounded shadow-md ">
      ...
      {/* Deskripsi */}
      <section className="relative mt-[80px] py-12 flex gap-10 mt-10 mx-10 sm:mx-64 rounded-xl sm:rounded-xl">
        <div className="w-[70%] py-5 ">
          ...
          <div className="bg-white mt-10">
            <div className="bg-white py-5 rounded-lg border-2 border-gray-200">
              ...
              <div className="px-8 mt-4 text-[#333333AD] text-sm sm:text-base flex  gap-5 ">
                <div className="flex items-center gap-3 bg-white w-[50%] p-3 border-2 border-gray-200 rounded-lg">
        ...
        <div className="w-[30%] py-5 px-2">
          <div className="bg-white py-5 rounded-lg border-2 border-gray-200">
            <p className="text-[20px] text-[#222325] font-bold px-8">{title}</p>
            <div className="flex gap-2">
            <p className="text-[23px] text-[#3ECF4C] font-semibold text-sm pl-8 pt-4">{price}</p>
            <p className="text-[23px] text-[#3A354161] font-semibold text-sm pt-4">Rp 100k</p>
            </div>
             <p className="text-[23px] text-[#0980E2] font-semibold text-sm pl-8 pt-4">info diskon</p>
             <button className="bg-[#3ECF4C] text-center py-2 mx-8 mt-4 px-[75px] rounded-lg" >Beli Sekarang</button>
      ...
      <section className=" py-8 sm:py-3 mx-10 sm:mx-64 my-10 sm:my-0">
        <h3 className="text-xl font-semibold mb-4">Video Pembelajaran Terkait Lainnya</h3>
