  ...
  return (
    <section className="sm:py-12 mx-10 sm:mx-64">
      ...
      <div className="sm:hidden flex items-center text-gray-400 mb-6">
        <i className={`ri-radio-button-line text-[30px] ${selectedMethod ? "text-[#3ECF4C]" : "text-gray-300"}`}></i>
        ...
        <span className="text-[12px] my-auto mr-2">Bayar</span>
      ...
      <div className="sm:flex sm:gap-10">
        ...
        <div className="hidden sm:block w-full sm:w-[30%] py-5 order-1 sm:order-2">
          <div className="bg-white py-5 rounded-lg border-2 border-gray-200 px-5">
            ...
            <p className="text-[20px] text-[#222325] font-bold">{state.title}</p>
            <div className="flex gap-2">
              <p className="text-[24px] text-[#3ECF4C] font-semibold text-sm pt-4">{formatPrice(state.price, true)}</p>
